...
| Date          | Update        |
| ------------- | ------------- |    
| 2018-08-27      | **Colab support:** A [colab notebook](https://colab.research.google.com/github/AlasdairWalker/faceswap-GAN/blob/master/colab_demo/faceswap-GAN_colab_demo.ipynb) for faceswap-GAN v2.2 is provided.| 
